...
ard_compare <- function(x, y, key_columns = NULL) {
  ...
  .validate_environment_metadata(environments_x, environments_y)
  ...
  mismatch_list <- lapply(comparison_targets, .build_mismatches, comparison = comparison, key_columns = key_columns)
